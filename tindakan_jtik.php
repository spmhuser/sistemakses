...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (in_array($kelulusan, ['DILULUSKAN','TIDAK_DILULUSKAN'])) {
        ...
        logAudit($id, $status === 'DILULUSKAN' ? 'KELULUSAN_JTIK' : 'TOLAK_JTIK', $alasan);
    ...
    <div class="view-card mb-4">
        ...
        <div class="view-card-body">
            ...
            <div style="margin-top:14px;overflow-x:auto">
                <label style="font-size:0.85rem;font-weight:600;text-transform:uppercase;color:#6E6470;display:block;margin-bottom:8px">Sistem Dipohon</label>
            ...
            <?php endif; ?>
            <div style="margin-top:12px"><a href="view_permohonan.php?id=<?=$r['id']?>" style="font-size:0.92rem;color:#2C5488;font-weight:600"><i class="bi bi-eye me-1"></i>Lihat permohonan penuh</a></div>
        </div>
    </div>
    ...
    <div class="form-card">
        ...
        <div class="form-section-body">
            <form method="POST" id="jtikForm">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-5">
                        <label class="keputusan-card" id="cardLulus">
                            ...
                            <div><div style="font-weight:700;color:#166534">DILULUSKAN</div><div style="font-size:0.88rem;color:#6b7280">Permohonan diluluskan</div></div>
                        </label>
                    </div>
                    <div class="col-md-5">
                        <label class="keputusan-card" id="cardTolak">
                            ...
                            <div><div style="font-weight:700;color:#991b1b">TIDAK DILULUSKAN</div><div style="font-size:0.88rem;color:#6b7280">Permohonan ditolak</div></div>
                        </label>
                    </div>
                </div>
                <div class="mb-4">
                ...
                <div style="font-size:0.92rem;color:#6b7280;margin-bottom:16px">
