...
<div class="main-content">
    ...
    <!-- Section A -->
    <div class="view-card">
        <div class="view-card-header"><span style="background:#115e59;color:#fff;font-size:0.72rem;font-weight:700;padding:3px 9px;border-radius:6px">A</span><h6>Maklumat Kakitangan</h6></div>
    ...
    <!-- Section B -->
    <div class="view-card">
        <div class="view-card-header"><span style="background:#115e59;color:#fff;font-size:0.72rem;font-weight:700;padding:3px 9px;border-radius:6px">B</span><h6>Maklumat Sistem</h6></div>
        <div class="view-card-body">
            ...
            <table class="sistem-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span style="display:inline-block;font-size:0.7rem;padding:2px 6px;border-radius:10px;background:#ccfbf1;color:#115e59;font-weight:600"><?= fungsiLabel($f) ?></span>
                        <?php endforeach; ?>
    ...
    <!-- Status Timeline -->
    <div class="view-card">
        <div class="view-card-header"><i class="bi bi-activity me-2" style="color:#115e59"></i><h6>Status Permohonan</h6></div>
        <div class="view-card-body">
            <ul class="timeline">
    ...
    <?php if ($r['tarikh_pengarah_jab']): ?>
    <div class="view-card">
        <div class="view-card-header"><span style="background:#115e59;color:#fff;font-size:0.72rem;font-weight:700;padding:3px 9px;border-radius:6px">E</span><h6>Perakuan Pengarah Jabatan</h6></div>
        <div class="view-card-body">
            <div class="info-row">
    ...
    <?php if ($r['tarikh_jtik']): ?>
    <div class="view-card">
        <div class="view-card-header"><span style="background:#115e59;color:#fff;font-size:0.72rem;font-weight:700;padding:3px 9px;border-radius:6px">F</span><h6>Kelulusan Pengarah JTIK</h6></div>
        <div class="view-card-body">
            <div class="info-row">
    ...
    <?php if ($r['tarikh_it']): ?>
    <div class="view-card">
        <div class="view-card-header"><span style="background:#115e59;color:#fff;font-size:0.72rem;font-weight:700;padding:3px 9px;border-radius:6px">G</span><h6>Kegunaan IT</h6></div>
        <div class="view-card-body">
            <div class="info-row">
