...
<div class="main-content">
    ...
    <!-- Section A -->
    <div class="view-card">
        <div class="view-card-header"><span class="bg-sec-label">A</span><h6>Maklumat Kakitangan</h6></div>
    ...
    <!-- Section B -->
    <div class="view-card">
        <div class="view-card-header"><span class="bg-sec-label">B</span><h6>Maklumat Sistem</h6></div>
        <div class="view-card-body">
    ...
    <!-- Status Timeline -->
    <div class="view-card">
        <div class="view-card-header"><i class="bi bi-activity me-2" style="color:#1e4976"></i><h6>Status Permohonan</h6></div>
        <div class="view-card-body">
            <ul class="timeline">
    ...
    <?php if ($r['tarikh_pengarah_jab']): ?>
    <div class="view-card">
        <div class="view-card-header"><span class="bg-sec-label">E</span><h6>Perakuan Pengarah Jabatan</h6></div>
        <div class="view-card-body">
            <div class="info-row">
    ...
    <?php if ($r['tarikh_jtik']): ?>
    <div class="view-card">
        <div class="view-card-header"><span class="bg-sec-label">F</span><h6>Kelulusan Pengarah JTIK</h6></div>
        <div class="view-card-body">
            <div class="info-row">
    ...
    <?php if ($r['tarikh_it']): ?>
    <div class="view-card">
        <div class="view-card-header"><span class="bg-sec-label">G</span><h6>Kegunaan IT</h6></div>
        <div class="view-card-body">
            <div class="info-row">
