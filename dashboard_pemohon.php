            ...
            <table class="data-table tbl-resp">
                ...
                <tr>
                    ...
                    <td class="cell-act" style="display:flex;gap:6px;flex-wrap:wrap">
                        ...
                        <?php if ($r['status'] === 'TIDAK_DILULUSKAN'): ?>
                        <a href="borang_permohonan.php?resubmit=<?=$r['id']?>" class="btn-primary-dark" style="padding:5px 12px;font-size:0.88rem"><i class="bi bi-arrow-repeat"></i> Mohon Semula</a>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php endforeach; endif; ?>
