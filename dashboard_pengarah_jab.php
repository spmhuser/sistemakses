...
$db = getDB();
// Routing ikut jabatan: pengarah hanya nampak permohonan jabatan yang ditugaskan kepadanya
...
<head>
    ...
    <style>
        ...
        @media (max-width:768px){
            ...
            .dash-tab .tab-txt{font-size:0.8rem}
            ...
            .bulk-bar .bulk-select,.bulk-bar .btn-primary-dark{width:100%;justify-content:center}
            .bulk-bar .btn-primary-dark{padding:11px 18px!important}
        }
    </style>
</head>
<body>
...
<div class="main-content">
    ...
    <div id="tab-proses" class="dash-tab-pane active">
        ...
        <div class="table-card">
            <table class="data-table tbl-resp">
                <thead><tr><th style="padding-left:24px;width:46px"><input type="checkbox" class="row-allhead" onclick="toggleAll(this)"></th><th>No. Rujukan</th><th>Pemohon</th><th>Jabatan</th><th>Sistem</th><th>Tujuan</th><th>Tarikh Mohon</th><th>Tindakan</th></tr></thead>
                <tbody>
                <?php if(empty($perlu)): ?>
                <tr><td colspan="8" class="cell-empty"><div class="empty-state"><i class="bi bi-check2-circle"></i>Tiada permohonan menunggu perakuan.</div></td></tr>
                <?php else: foreach(array_values($perlu) as $i=>$r): ?>
                <tr>
                    <td class="cell-chk" data-label="Pilih" style="padding-left:24px"><input type="checkbox" class="rowchk" name="ids[]" value="<?=$r['id']?>" onclick="updCount()"></td>
    ...
    <div id="tab-selesai" class="dash-tab-pane">
        <div class="table-card">
            <table class="data-table tbl-resp">
                <thead><tr><th style="padding-left:24px">#</th><th>No. Rujukan</th><th>Pemohon</th><th>Jabatan</th><th>Sistem</th><th>Tujuan</th><th>Status</th><th>Tarikh Peraku</th><th>Lihat</th></tr></thead>
                <tbody>
                ...
                <tr>
                    ...
                    <td data-label="Tarikh Peraku" style="color:#6E6470;font-size:0.9rem"><?= $r['tarikh_pengarah_jab'] ?? '-' ?></td>
